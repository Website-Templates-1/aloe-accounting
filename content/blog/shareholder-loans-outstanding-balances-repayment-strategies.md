---
title: >-
  Shareholder Loans: What to Do With Outstanding Balances (and How Repayment
  Works)
slug: shareholder-loans-outstanding-balances-repayment-strategies
metaDescription: >-
  Learn how director/shareholder loans are treated in Canada, CRA review
  indicators, interest considerations, and practical repayment timing.
excerpt: >-
...
faqs:
  - question: 'What is a director/shareholder loan, and how does it usually happen?'
    answer: >-
      It’s a balance created when money flows between a corporation and a
      shareholder/director outside of payroll (salary), formal dividends, or a
      properly documented loan. Common causes include corporate payments of
      personal expenses or shareholder withdrawals from the corporation.
  - question: >-
      Does CRA automatically consider an outstanding shareholder loan a
      dividend?
    answer: >-
      Not automatically, but CRA can scrutinize the facts. If amounts appear to
      be personal spending supported by the corporation, CRA may treat the
      result as a distribution or adjust the tax position depending on the
      circumstances and timing.
  - question: How can I tell if my shareholder loan will be reviewed by CRA?
    answer: >-
      CRA attention often increases when there are large or repeatedly
      outstanding balances at fiscal year-end, no clear loan documentation,
      frequent unclear transactions, and repayments that are delayed or
      inconsistent with the stated loan purpose.
  - question: Do I need to pay interest on a shareholder loan?
    answer: >-
      Potentially, yes. Whether interest and/or an imputed benefit applies
      depends on the facts and timing (for example, who owes whom and the dates
      of advances). Because the rules are technical, confirm with a tax
      professional.
  ...
  - question: What records should I keep for shareholder loan transactions?
    answer: >-
      Keep a detailed shareholder loan ledger with transaction dates and
      descriptions, supporting bank transaction records, and ideally a written
      loan agreement and related corporate documentation (such as minutes) where
      appropriate.
peopleAlsoSearch:
  ...
  - label: Business advisory support
...
Use clear [bookkeeping](/services/accounting-payroll) entries and supporting records:
...
[ALOE Accounting and Tax](/contact) can help you review your shareholder loan ledger and assess practical clearance steps as part of your overall [tax-planning](/services/tax-planning) for your corporation.
